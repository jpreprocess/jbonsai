...
[HTS Engine](https://hts-engine.sourceforge.net)をRustで書き直したものなので，HTS Engine用の音声モデルが流用できます（ただし日本語に限る）．

なお，jbonsaiとHTS Engineの出力が完全一致することは保証されていません．現状でも不動小数点演算の微妙な違いにより，（整数に変換した際に丸められて同じになることがほとんどですが）合成品質にほとんど影響しない範囲ではあるものの，音声波形に違いがあります．
