...
unsafe extern "C" fn HTS_mlsafir(
    ...
    *d
        ...
        ) = aa * *d.offset(0 as libc::c_int as isize)
...
unsafe extern "C" fn HTS_mlsadf1(
    ...
    while i >= 1 as libc::c_int {
        *d
            .offset(
                i as isize,
            ) = aa * *pt.offset((i - 1 as libc::c_int) as isize)
            + a * *d.offset(i as isize);
        *pt
            .offset(
                i as isize,
            ) = *d.offset(i as isize) * *b.offset(1 as libc::c_int as isize);
...
unsafe extern "C" fn HTS_nrandom(mut v: *mut HTS_Vocoder) -> libc::c_double {
    if (*v).sw as libc::c_int == 0 as libc::c_int {
        ...
        loop {
            (*v)
                .r1 = 2 as libc::c_int as libc::c_double * HTS_rnd(&mut (*v).next)
                - 1 as libc::c_int as libc::c_double;
            (*v)
                .r2 = 2 as libc::c_int as libc::c_double * HTS_rnd(&mut (*v).next)
                - 1 as libc::c_int as libc::c_double;
            ...
            *b.offset(m as isize) = *mc.offset(m as isize);
            ...
            while m >= 0 as libc::c_int {
                *b
                    .offset(
                        m as isize,
                    ) = *mc.offset(m as isize)
                    - a * *b.offset((m + 1 as libc::c_int) as isize);
                m -= 1;
                m;
            }
        } else {
    ...
    while i <= 0 as libc::c_int {
        ...
        if 1 as libc::c_int <= m2 {
            ...
            *g
                .offset(
                    1 as libc::c_int as isize,
                ) = b * *((*v).freqt_buff).offset(0 as libc::c_int as isize)
                + a * *fresh6;
        }
        j = 2 as libc::c_int;
        while j <= m2 {
            ...
            *g
                .offset(
                    j as isize,
                ) = *((*v).freqt_buff).offset((j - 1 as libc::c_int) as isize)
...
unsafe extern "C" fn HTS_c2ir(
    ...
    *h.offset(0 as libc::c_int as isize) = exp(*c.offset(0 as libc::c_int as isize));
    ...
    while n < leng {
        ...
        while k <= upl {
            d
                += k as libc::c_double * *c.offset(k as isize)
                    * *h.offset((n - k) as isize);
            k += 1;
            k;
        }
...
unsafe extern "C" fn HTS_b2en(
    ...
    if (*v).spectrum2en_size < m as size_t {
        ...
        (*v)
            .spectrum2en_buff = HTS_calloc(
            (m + 1 as libc::c_int + 2 as libc::c_int * 576 as libc::c_int) as size_t,
            ::core::mem::size_of::<libc::c_double>() as libc::c_ulong,
        ) as *mut libc::c_double;
        (*v).spectrum2en_size = m as size_t;
    }
    cep = ((*v).spectrum2en_buff).offset(m as isize).offset(1 as libc::c_int as isize);
...
unsafe extern "C" fn HTS_ignorm(
    ...
    if g != 0.0f64 {
        ...
        *c2
            ...
            ) = log(*c1.offset(0 as libc::c_int as isize));
    };
}
unsafe extern "C" fn HTS_gnorm(
    ...
    if g != 0.0f64 {
        ...
        *c2
            .offset(
                0 as libc::c_int as isize,
            ) = exp(*c1.offset(0 as libc::c_int as isize));
    };
}
unsafe extern "C" fn HTS_lsp2lpc(
    ...
    while i < mh2 {
        *q
            ...
            * cos(*((*v).lsp2lpc_buff).offset((k + 1 as libc::c_int) as isize));
        i += 1;
        i;
        k += 2 as libc::c_int;
    }
...
unsafe extern "C" fn HTS_gc2gc(
    ...
    *c2
        .offset(
            0 as libc::c_int as isize,
        ) = *((*v).gc2gc_buff).offset(0 as libc::c_int as isize);
    i = 1 as libc::c_int;
    while i <= m2 {
        ss2 = 0.0f64;
        ss1 = ss2;
        ...
        if i <= m1 {
            *c2
                .offset(
                    i as isize,
                ) = *((*v).gc2gc_buff).offset(i as isize)
                + (g2 * ss2 - g1 * ss1) / i as libc::c_double;
        } else {
...
unsafe extern "C" fn HTS_mglsadff(
    ...
    *d
        ...
        + (1 as libc::c_int as libc::c_double - a * a) * x;
    return x;
}
...
unsafe extern "C" fn HTS_check_lsp_stability(
    mut lsp: *mut libc::c_double,
    mut m: size_t,
) {
    let mut i: size_t = 0;
...
unsafe extern "C" fn HTS_lsp2en(
    ...
    buff = ((*v).spectrum2en_buff).offset(m as isize).offset(1 as libc::c_int as isize);
    HTS_lsp2lpc(
        v,
    ...
    if (*v).use_log_gain != 0 {
        ...
        *((*v).spectrum2en_buff)
            .offset(0 as libc::c_int as isize) = *lsp.offset(0 as libc::c_int as isize);
    }
    HTS_ignorm(
        (*v).spectrum2en_buff,
        (*v).spectrum2en_buff,
...
unsafe extern "C" fn HTS_Vocoder_start_excitation(
    ...
    if (*v).pitch_of_curr_point != 0.0f64 && pitch != 0.0f64 {
        (*v)
            .pitch_inc_per_point = (pitch - (*v).pitch_of_curr_point)
...
unsafe extern "C" fn HTS_Vocoder_excite_unvoiced_frame(
    ...
    let mut center: size_t = ((*v).excite_buff_size)
        .wrapping_sub(1 as libc::c_int as size_t) / 2 as libc::c_int as size_t;
    *((*v).excite_ring_buff)
        .offset(
            (((*v).excite_buff_index).wrapping_add(center) % (*v).excite_buff_size)
                as isize,
        ) += noise;
}
unsafe extern "C" fn HTS_Vocoder_excite_voiced_frame(
    ...
    if noise != 0.0f64 {
        ...
        while i < (*v).excite_buff_size {
            if i == center {
                *((*v).excite_ring_buff)
                    .offset(
                        (((*v).excite_buff_index).wrapping_add(i)
                            % (*v).excite_buff_size) as isize,
    ...
    if pulse != 0.0f64 {
        ...
        while i < (*v).excite_buff_size {
            *((*v).excite_ring_buff)
                .offset(
                    (((*v).excite_buff_index).wrapping_add(i) % (*v).excite_buff_size)
                        as isize,
...
pub unsafe extern "C" fn HTS_Vocoder_initialize(
    ...
    if (*v).stage == 0 as libc::c_int as size_t {
        ...
        (*v).cc = ((*v).c).offset(m as isize).offset(1 as libc::c_int as isize);
        (*v).cinc = ((*v).cc).offset(m as isize).offset(1 as libc::c_int as isize);
        (*v).d1 = ((*v).cinc).offset(m as isize).offset(1 as libc::c_int as isize);
    } else {
        (*v)
            .c = HTS_calloc(
            m.wrapping_add(1 as libc::c_int as size_t)
    ...
    if (*v).stage == 0 as libc::c_int as size_t {
        ...
        while i as size_t <= m {
            *((*v).cinc)
                .offset(
                    i as isize,
                ) = (*((*v).cc).offset(i as isize) - *((*v).c).offset(i as isize))
                / (*v).fprd as libc::c_double;
            i += 1;
            i;
        }
